...
public class Vendor extends UniqueListItem {
     ...
     */
    public Vendor(Name name, Email email, Set<Tag> tags, VendorId vendorId, Phone phone, ServiceName serviceName,
                  Address address, Cost cost, OperatingHours operatingHours) {
